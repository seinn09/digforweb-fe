...
type RegisterProps = {
  onRegister: (name: string, email: string, password: string, contact: string) => void;
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-cyan-400 mb-2">Create Account</h1>
            <p className="text-slate-400">Join DigForWeb</p>
          </div>
